...
fn main() {
  ...
  let regress_table = run_bench(
    gen_projs![
      ...
      (LibertyDb0p10p, liberty_db_0p10p0::Library<liberty_db_0p10p0::DefaultCtx>),
      (LibertyDb0p9p, liberty_db_0p9p6::Library<liberty_db_0p9p6::DefaultCtx>),
