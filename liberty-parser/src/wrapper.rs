...
pub(crate) fn space<'a, E>(i: &'a str) -> IResult<&'a str, &'a str, E> 
where
  E: ParseError<&'a str> 
   + ContextError<&'a str> 
...
pub fn space_newline<'a, E>(i: &'a str) -> IResult<&'a str, &'a str, E> 
where
  E: ParseError<&'a str> 
   + ContextError<&'a str> 
   + FromExternalError<&'a str, E>
...
pub(crate) fn space_newline_complex<'a, E>(i: &'a str) -> IResult<&'a str, &'a str, E> 
where
  E: ParseError<&'a str> 
   + ContextError<&'a str> 
   + FromExternalError<&'a str, E>
...
pub(crate) fn unquote_multi<'a, E>(
  i: &'a str,
