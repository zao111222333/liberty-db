...
impl Library {
  ...
  #[inline]
  pub fn parse(i: &str) -> Result<Self, ParserError<'_>> {
    let mut line_num = 1;
  ...
  #[inline]
  fn fmt<I: crate::ast::Indentation>(
    &self,
    f: &mut core::fmt::Formatter<'_>,
  ) -> Result<(), core::fmt::Error> {
    let ff = &mut crate::ast::CodeFormatter::<'_, core::fmt::Formatter<'_>, I>::new(f);
